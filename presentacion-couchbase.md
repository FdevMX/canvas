...
| Característica | Couchbase | MongoDB | Cassandra | Redis | MySQL | SQL Server |
|----------------|-----------|---------|-----------|-------|-------|------------|
| **Data Model** | Multi-model | Documento | Wide-column | KV/Cache | Relacional | Relacional |
| **Query Language** | N1QL (SQL-like) | MQL | CQL | Commands | SQL | T-SQL |
| **Caching** | Integrado | Externo | Externo | Nativo | Externo | Externo |
| **Mobile Sync** | Sí (nativo) | No | No | No | No | No |
| **ACID Transactions** | Sí | Limitado | No | No | Sí | Sí |
| **Memory-first** | Sí | No | No | Sí | No | No |
